<?php include 'includes/header.php' ?>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-2 py-4">
        <!-- Todays expense -->
  ...
  <!-- charts container -->
    <div class="flex flex-col items-center md:flex-row gap-2 mb-2">
        ...
        <div class="mx-auto overflow-hidden p-4 bg-white rounded-lg shadow">
            ...
            <canvas
                ...
                data-te-labels="['Main farm', 'Gulu farm' , 'Masindi farm']"
                data-te-dataset-data="[20000, 30000, 15000]"
                data-te-dataset-background-color="['rgb(255, 0, 0)', 'rgb(0, 102, 255)', 'rgb(0, 204, 0)']" height="300" class="w-80 lg:w-96">
            </canvas>
        </div>    
    </div>
    ...
    <!-- last Activity table -->
    <div class="bg-white p-2 rounded-lg shadow w-full md:w-full lg:w-3/4 xl:w-1/2">
