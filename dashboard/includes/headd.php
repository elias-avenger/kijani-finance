...
<head>
    ...
    <title>DashBoard - kijani Finance system</title>
    ...
    <div class="flex flex-col md:flex-row p-4 gap-4">
        <nav class="hidden md:flex flex-col w-1/6 bg-white rounded-lg h-fit px-4 pb-8 pt-4">
            <a href="dashboard.php" class="flex p-2 mb-4">
                <img src="https://kijaniforestry.com/wp-content/uploads/2019/03/cropped-Kijani_Logo_BW_Circle-03.png" class="w-12" alt="">
            ...
            <div class="flex w-full py-4">
                &copy; <span id="year"></span> Kijani Forestry Finance
            </div>
        </nav>
        ...
        <div class="md:w-5/6 rounded-lg h-max">
             <!-- upper bar -->
            <div class="flex justify-end w-full rounded-lg  bg-green-900 shadow p-2">
